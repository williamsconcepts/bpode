...
<div class='callout'>
This links to <a href='https://bpode.com/episodes/neel'>episode 9</a> with Neel Nanda, where Neel discusses the value of using the 'outside view' to avoid the planning fallacy.
</div>
